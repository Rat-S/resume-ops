...
class ResumeGraph:
    def __init__(
        ...
        *,
        ...
        graph.add_edge("work_tailoring", "education_tailoring")
        graph.add_edge("education_tailoring", "skills_tailoring")
        graph.add_edge("skills_tailoring", "projects_tailoring")
        graph.add_edge("projects_tailoring", "certificates_selection")
        graph.add_edge("certificates_selection", "optional_sections_tailoring")
